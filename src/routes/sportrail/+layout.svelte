...
<!-- Navigation -->
<nav class="bg-sport-dark/95 backdrop-blur-sm fixed w-full z-50 border-b border-sport-accent/20">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center h-16 lg:h-20">
      ...
      <a href="/sportrail" class="flex items-center gap-3">
        ...
        <div>
          <span class="text-white font-sport-heading font-bold text-xl tracking-tight">SPORTRAIL</span>
          <span class="hidden sm:inline text-sport-accent text-xs ml-2 font-sport-body uppercase tracking-widest">Football Education</span>
        </div>
      </a>
      ...
      <div class="hidden lg:flex items-center gap-1">
        {#each navLinks as link}
          <a
            href={link.href}
            class="px-3 py-2 text-sm font-sport-body text-sport-gray-200 hover:text-white hover:bg-sport-secondary/30 rounded-lg transition-colors"
          >
            {link.label}
          </a>
        {/each}
    ...
    <!-- Mobile Nav -->
    {#if mobileMenuOpen}
      <div class="lg:hidden pb-4 border-t border-sport-accent/20 mt-2 pt-4">
        {#each navLinks as link}
          <a
            href={link.href}
            class="block px-4 py-3 text-sport-gray-200 hover:text-white hover:bg-sport-secondary/20 rounded-lg font-sport-body"
...
<!-- Page Content -->
<main class="pt-16 lg:pt-20 bg-white min-h-screen font-sport-body text-sport-gray-800">
  {@render children()}
</main>

<!-- Footer -->
<footer class="bg-sport-dark text-sport-gray-300 font-sport-body">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
      ...
      <div class="lg:col-span-1">
        ...
        <div class="flex gap-3">
          ...
          <a href="https://instagram.com/sportrail_pt" target="_blank" rel="noopener" class="w-9 h-9 bg-sport-secondary/30 hover:bg-sport-accent rounded-lg flex items-center justify-center transition-colors" aria-label="Instagram">
          ...
          <a href="https://www.linkedin.com/showcase/sportrail-global" target="_blank" rel="noopener" class="w-9 h-9 bg-sport-secondary/30 hover:bg-sport-accent rounded-lg flex items-center justify-center transition-colors" aria-label="LinkedIn">
      ...
      <!-- Contact -->
      <div>
        <h3 class="text-white font-sport-heading font-semibold text-sm uppercase tracking-wider mb-4">Contact</h3>
        <ul class="space-y-2.5 text-sm">
          <li class="flex items-start gap-2">
            <svg class="w-4 h-4 mt-0.5 shrink-0 text-sport-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
            <span>Rua Sao Salvador da Baia,<br/>ED. AERLIS, 2780-019 Oeiras</span>
          </li>
          <li class="flex items-center gap-2">
            <svg class="w-4 h-4 shrink-0 text-sport-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
            <a href="mailto:geral@sportrail.pt" class="hover:text-sport-accent transition-colors">geral@sportrail.pt</a>
          </li>
          <li class="flex items-center gap-2">
            <svg class="w-4 h-4 shrink-0 text-sport-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
            <a href="tel:+351924355598" class="hover:text-sport-accent transition-colors">+351 924 355 598</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <!-- Certifications Bar -->
    <div class="mt-12 pt-8 border-t border-sport-secondary/30">
      <div class="flex flex-wrap items-center justify-between gap-4">
        <div class="flex items-center gap-6">
          <div class="flex items-center gap-2 text-xs text-sport-gray-400">
            <div class="w-8 h-8 bg-sport-secondary/20 rounded flex items-center justify-center text-sport-accent font-sport-heading font-bold text-[10px]">DGERT</div>
            <span>Certified Entity</span>
          </div>
          <div class="flex items-center gap-2 text-xs text-sport-gray-400">
            <div class="w-8 h-8 bg-sport-secondary/20 rounded flex items-center justify-center text-sport-accent font-sport-heading font-bold text-[10px]">IPDJ</div>
            <span>Accredited</span>
          </div>
        </div>
        <p class="text-xs text-sport-gray-500">&copy; {new Date().getFullYear()} Sportrail. All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
