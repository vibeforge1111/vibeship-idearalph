...
<main class="bg-playground-sunset overflow-hidden">
  ...
  <section id="get-started" class="bg-gradient-to-b from-playground-green/20 to-white py-16 px-4">
    <div class="max-w-2xl mx-auto text-center">
      <div class="flex justify-center mb-4">
        <button class="w-16 h-16 bg-playground-green rounded-full flex items-center justify-center border-4 border-chalkboard shadow-crayon transition-all duration-150 hover:translate-x-1 hover:translate-y-1 hover:shadow-none hover:rotate-3 cursor-pointer">
          <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/>
            <path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/>
            <path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"/>
  ...
  <section class="bg-white py-16 px-4">
    <div class="max-w-2xl mx-auto">
      <div class="flex justify-center mb-4">
        <button class="w-16 h-16 bg-ralph-yellow rounded-full flex items-center justify-center border-4 border-chalkboard shadow-crayon transition-all duration-150 hover:translate-x-1 hover:translate-y-1 hover:shadow-none hover:-rotate-3 cursor-pointer">
          <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
